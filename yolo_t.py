...
from yolo3.model2 import yolo_eval, yolo_body, tiny_yolo_body, tiny_yolo_body_expand
...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data/yolov3-tiny_obj_final666.h5',
    ...
    def generate(self):
        ...
        try:
            ...
            self.yolo_model = tiny_yolo_body_expand(Input(shape=(None,None,3)), num_anchors//2, num_classes) \
    ...
    def detect_image(self, image):
        ...
        intermediate_layer_model = Model(inputs=self.yolo_model.input, outputs=self.yolo_model.get_layer("up_sampling2d_1").output)
        up_sampling2d_1 = intermediate_layer_model.predict(image_data)
        ...
        print(end - start)
        return image, getconfig, getweight, leaky_re_lu_10, up_sampling2d_1, image_data
