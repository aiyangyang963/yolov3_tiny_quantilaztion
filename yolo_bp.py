...
class YOLO(object):
    ...
    def search_layers_weight(self, image):
        start = timer()
        #####test
        ...
        convwegt_1 = getweight[1][0]
        convbias_1 = getweight[1][1]
        q_convbias_1 = [ quant_weight(convwegt_1, self.p_bit, self.n_bit, self.valid), quant_weight(convbias_1, self.p_bit, self.n_bit, self.valid)]
        
        
        print('success1')
        self.yolo_model.get_layer('conv2d_1').set_weights(q_convbias_1)
        '''
        print('success2')
