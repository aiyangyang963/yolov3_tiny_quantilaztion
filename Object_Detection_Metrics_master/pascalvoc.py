...
parser.add_argument(
    ...
    '--gtfolder',
    dest='gtFolder',
    default=os.path.join(currentPath, '/home/vdl/Desktop/darknet/scripts/groundtruths_val_dehze'),
    metavar='',
...
parser.add_argument(
    ...
    '--detfolder',
    dest='detFolder',
    default=os.path.join(currentPath, '/home/vdl/Desktop/keras-yolo3-master/detections_val_dehze'),
    metavar='',
